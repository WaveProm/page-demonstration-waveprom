    ...
    <div className="mx-4">
      <header>
        ...
        <p className="mt-2 text-[22px]">
          <span className="font-medium">Qu’importe / Groupe Chuard</span> / Bar
          à vin
        </p>
      </header>
      ...
      <p className="my-6 max-w-3xl text-pretty font-medium text-[18px] lg:my-8 lg:text-[24px]">
        «&nbsp;Incontournable <br className="lg:hidden" /> bar carougeois&nbsp;»{" "}
      ...
      <p className="max-w-3xl text-pretty text-[16px] text-gray-600 lg:text-[20px]">
        ...
        recommandons <br className="lg:hidden" /> vivement leurs
        services.&nbsp;»
      </p>
      {/* No name and no role came back from this one, so the whole
          line is the accent it would otherwise have carried. */}
      <p className="mt-2 font-medium text-[16px]">Qu’importe / Groupe Chuard</p>
    </div>
